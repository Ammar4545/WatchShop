...
namespace WatchShop.Services
{
    public class ProductService
    {
        ...
        public ProductService()
        {
            ...
            new Product{Id=6,NAme="test5",Description="OUPINKE Men's Wrist Watches Automatic Mechanical Luxury Skeleton Self Winding Sapphire Crystal Waterproof Tungsten Steel Band",ImageUrl="https://m.media-amazon.com/images/I/61xSjdpeU0L._AC_UL320_.jpg",Price=35,Specification=""}
            };
        }
